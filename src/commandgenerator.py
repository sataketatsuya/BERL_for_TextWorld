...
class CommandModel:
    ...
    def command_parser(self, cmd):
        ...
        return {'verb': verb, 'entity': entity, 'preposition': preposition, 'entity2': entity2}
    ...
    def filter_templates(self, templates):
        ...
        tp = [cmd.replace('{oven}','oven').replace('{stove}','stove').replace('{toaster}','BBQ') for cmd in templates]
